    ...
    <div
      className={`min-h-screen transition-all duration-500 ${
        darkMode
          ...
          : "bg-[radial-gradient(circle_at_top_left,#f5f3ff,white_35%,#eef2ff_75%,#f8fafc)] text-slate-900"
      }`}
    >
      ...
      <main className="relative px-12 pt-10 pb-10 max-w-[1400px] mx-auto">

        {/* Header */}
        <div className="mb-10 flex justify-between items-start flex-wrap gap-6">

          <div>
            <h1 className="text-6xl font-black tracking-tight bg-gradient-to-r from-purple-400 to-blue-500 bg-clip-text text-transparent">
              🏫 SchoolOS Pro
            </h1>

            <p className={`${darkMode ? "text-slate-300" : "text-slate-600"} text-xl mt-3 opacity-80`}>
          ...
          <button
            ...
            className={`px-5 py-3 rounded-2xl backdrop-blur-xl shadow-xl transition-all duration-300 hover:scale-105 ${
              darkMode
                ...
                : "bg-white/70 backdrop-blur-xl border border-white shadow-xl text-slate-900 hover:bg-white"
            }`}
          >
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-10">
          ...
          <div
            className={`p-5 rounded-3xl ${
              darkMode
                ? "bg-white/10"
                : "bg-white/70 backdrop-blur-xl border border-white/70 shadow-[0_12px_40px_rgba(15,23,42,0.08)]"
            }`}
          >
            <p className="opacity-70 mb-3">Search Schools</p>
            ...
            <input
              ...
              className={`w-full p-3 rounded-2xl border outline-none focus:ring-2 focus:ring-purple-500/40 transition-all duration-300 ${
                darkMode
                  ...
                  : "bg-white/80 text-slate-900 border-slate-200 shadow-inner"
              }`}
            />
          </div>
          ...
          >
            <p className="opacity-70">Active Schools</p>
            <h2 className="text-4xl font-bold">{schools.length}</h2>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-[1.05fr_1fr] gap-10 items-start">
          ...
          {/* Add School */}
          <div
            className={`rounded-3xl p-8 min-h-[540px] shadow-[0_20px_60px_rgba(0,0,0,0.18)] ${
              darkMode
          ...
          >
            ...
            <div className="space-y-5 max-h-[440px] overflow-y-auto pr-2">
              ...
              {filteredSchools.map((school) => (
                <div
                  key={school.id}
                  className={`p-5 rounded-3xl transition-all duration-300 hover:scale-[1.02] ${
                    darkMode
